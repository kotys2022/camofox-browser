...
> ⚠️ Тека наразі ПОРОЖНЯ — вихідників тут ще нема. Треба клонувати/скопіювати сорс
> camofox-browser сюди. Доти єдиний референс коду — **шляхи всередині Docker-образу
> `camofox-browser:local`** (див. нижче), знайдені інспекцією образу.
