 ...
 *
 * (The multi-container pool itself is declarative NixOS orchestration, out of the
 * engine's scope per SPEC-camofox-pool-pattern-A; this is only the per-container
 * keep-warm half.)
 */
